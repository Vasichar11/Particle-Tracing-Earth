...
void Particles::calculations0(real Beq0, real initial_lamda, real initial_zeta, real initial_time, real initial_aeq, real initial_Ekev)
{
	...
	//std::cout<<"\naeq0 "<<initial_aeq<<" alpha0 "<<alpha0<<" speed0 "<< speed0 <<  " upar0 "<<upar0;
