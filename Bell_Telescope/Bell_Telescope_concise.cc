...
//--------------------------------------------------------------------SIMULATION------------------------------------------------------------------------//
	...
	for(int p=0; p<Constants::population; p++)     //Loop for all particles
	{
		...
		motion(p, eql_dstr[p].lamda.front(), eql_dstr[p].alpha.front(), eql_dstr[p].aeq.front(), eql_dstr[p].ppar.front(), eql_dstr[p].pper.front(), eql_dstr[p].upar.front(), eql_dstr[p].uper.front(), eql_dstr[p].zeta.front(), eql_dstr[p].M_adiabatic.front(), eql_dstr[p].eta.front(), eql_dstr[p].time.front(), ODPT);
