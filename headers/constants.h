...
namespace Universal
{
    ...
    const real Re=2;  				        //Earth mean radius in m.
...
namespace Particle_init
{
    ...
    const real lamda0=lamda0_deg*Universal::D2R;
...
namespace Simulation
{
    ...
    const real puls_dur=int(Wave_init::pulse_duration/h);		//Wave pulse duration in stepsize.
}
...
namespace Distribution
{
    ...
    const real lamda_domain_step = 0.001; //Latitude domain range precision
    //Final population
