#include"headers/struct_Particles.h"  //Include our declarations here


	//Define here 
	//Constructor for initial state, called once when object is created.
	Particles::Particles(real first_lamda, real first_zeta, real first_upar, real first_uper, real first_ppar, real first_pper, real first_alpha, real first_alpha2, real first_aeq, real first_aeq2, real first_time){ 
	...
	void Particles::update_state(real new_lamda, real new_zeta, real new_uper, real new_upar, real new_ppar, real new_pper, real new_alpha, real new_alpha2, real new_aeq, real new_aeq2, real new_eta, real new_time)
	{
