...
**Please click on the image** file so you can use the hyperlinks of the file. These can redirect to the respective modules of the code.
...
![Sensor sectors](./simulations/useful/sectors_PA_correlation.png)
...
As numberical method for the estimation of the particle variables, a fourth-order method of [Runge Kutta](https://en.wikipedia.org/wiki/Runge%E2%80%93Kutta_methods) has been used
