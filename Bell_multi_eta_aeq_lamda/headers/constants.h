...
const int64_t eta_dstr    = 3;					//eta distribution											 
const int64_t aeq_dstr    = 3;					//aeq distribution
const int64_t lamda_dstr  = 3;					//lamda distribution
...
const real lamda_start_d    = 0;     		//0 5 10				 				
const real lamda_end_d      = 10;   			
